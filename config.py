...
_GITHUB_APP_INSTALLATION_ID_RAW = os.environ["GITHUB_APP_INSTALLATION_ID"]
GITHUB_APP_INSTALLATION_IDS = [x.strip() for x in _GITHUB_APP_INSTALLATION_ID_RAW.split(",") if x.strip()]
GITHUB_APP_INSTALLATION_ID = GITHUB_APP_INSTALLATION_IDS[0]
